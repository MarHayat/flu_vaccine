...
Aux_data = read.csv("~/Aux_data.csv")
...
#2019
#=========================================================================================
data = read.csv("~/mycurrentdata2019_NA.csv",sep= ",",header=T,stringsAsFactors=FALSE)
data = data[,2:ncol(data)]
length(which(data$outcome==1))/nrow(data)
...
#2018
#=========================================================================================
data = read.csv("~\mycurrentdata2018_NA.csv",sep= ",",header=T,stringsAsFactors=FALSE)
data = data[,2:ncol(data)]
length(which(data$outcome==1))/nrow(data)
...
svmmodel.auc<-performance(svmmodel.prediction,"auc")@y.values[[1]]
round(svmmodel.auc,2)
plot(svmmodel.performance,type="l", lwd=1,col="green", ylab="",xlab="")
par(new=TRUE)
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
#2017
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
data = read.csv("~/mycurrentdata2017_NA.csv",sep= ",",header=T,stringsAsFactors=FALSE)
data = data[,2:ncol(data)]
length(which(data$outcome==1))/nrow(data)
...
svmmodel.auc<-performance(svmmodel.prediction,"auc")@y.values[[1]]
round(svmmodel.auc,2)
plot(svmmodel.performance,type="l", lwd=1,col="yellow", ylab="",xlab="")
par(new=TRUE)
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
#2016  
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
data = read.csv("~/mycurrentdata2016_NA.csv",sep= ",",header=T,stringsAsFactors=FALSE)
data = data[,2:ncol(data)]
colnames(data)
length(which(data$outcome==1))/nrow(data)
...
svmmodel.auc<-performance(svmmodel.prediction,"auc")@y.values[[1]]
round(svmmodel.auc,2)
plot(svmmodel.performance,type="l", lwd=1,col="darkgoldenrod",cex.lab=1, yaxt="n", xaxt="n", ylab="",xlab="")
title("ROC curve for classificaton using SVM " , adj = 0.5, line = 1,cex.main=1)
#axis(2,cex.axis=0.9)
mtext("True Positive rate", side=2, line=2.3, cex=1)
mtext("False Positive rate", side=1, line=2.5, cex=1)
abline(0,1,col="grey82",  lwd=0.8)
par(new=TRUE)
legend("bottomright", legend=c("2020-AUC:0.89-Accuracy:89%","2019-AUC:0.83-Accuracy:82%","2018-AUC:0.84-Accuracy:82%","2017-AUC:0.91-Accuracy:75%","2016-AUC:0.91-Accuracy:78%"), fill=c("red","blue","green","yellow","darkgoldenrod"), cex=0.7)
